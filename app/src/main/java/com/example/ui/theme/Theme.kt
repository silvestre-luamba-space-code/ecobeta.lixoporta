...
private val LightColorScheme = lightColorScheme(
    ...
    onPrimary = EcoLightOnPrimary,
    onSecondary = EcoLightOnPrimary,
    onBackground = EcoLightOnBackground,
    onSurface = EcoLightOnSurface
)

@Composable
fun MyApplicationTheme(
    darkTheme: Boolean = isSystemInDarkTheme(),
    // Set dynamicColor to false by default to preserve the beautiful corporate green Eco Beta brand colors!
